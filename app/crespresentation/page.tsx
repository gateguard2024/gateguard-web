...
export default function ColumbiaResPresentation() {
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 font-sans selection:bg-blue-200 overflow-x-hidden">
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12">
          ...
          <div className="bg-gradient-to-b from-blue-50 to-white rounded-2xl shadow-lg border border-blue-200 overflow-hidden relative h-full">
            ...
            <div className="p-8 space-y-6 relative z-10">
              ...
              <div>
                <h4 className="text-base font-bold text-blue-900 mb-1">5. Bulk Setup Discount</h4>
                <p className="text-blue-800/80 text-sm leading-relaxed">Reduce all setup fees to a flat $500 per entry point across the board—eliminating the $750 premium for repairing broken or decommissioned hardware.</p>
              </div>
            </div>
          </div>
      ...
      <section className="bg-slate-900 text-white py-24 px-6 mt-12">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="space-y-12">
            ...
            {/* Case Study 2: Mechanicsville Crossing (Historical Proof) */}
      ...
      {/* 4. REQUESTED STRATEGY MATRIX (With Mag Covers Callout) */}
      <section className="bg-slate-50 py-24 px-6 border-t border-slate-200">
        <div className="max-w-7xl mx-auto">
          ...
          {/* VANDAL PROOF MAG COVERS CALLOUT */}
          <div className="bg-slate-900 rounded-2xl p-8 shadow-2xl mb-12 border-l-[6px] border-blue-500 text-white relative overflow-hidden">
            ...
            <div className="relative z-10 grid md:grid-cols-[1.5fr,1fr] gap-8 items-center">
              <div>
                <h4 className="text-2xl font-bold mb-3 text-blue-300">Targeted Hardware Upgrade: Vandal-Proof Mag Covers</h4>
                <p className="text-slate-300 text-base leading-relaxed">
                  Installing custom metal covers prevents vandalism and dramatically reduces long-term maintenance on abused magnetic locks. Included as a core component of the quotes below.
                </p>
              </div>
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-slate-800 p-4 rounded-xl border border-slate-700 text-center shadow-inner">
                  <p className="text-[10px] text-slate-400 font-bold uppercase tracking-widest mb-1">Standard Installed</p>
                  <p className="text-2xl font-black text-white">$750 <span className="text-xs font-normal text-slate-500">/ ea</span></p>
                </div>
                <div className="bg-blue-900/40 p-4 rounded-xl border border-blue-500/30 text-center shadow-inner">
                  <p className="text-[10px] text-blue-300 font-bold uppercase tracking-widest mb-1">Bulk (13+ Sites)</p>
                  <p className="text-2xl font-black text-blue-100">$500 <span className="text-xs font-normal text-blue-400">/ ea</span></p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-12">
                ...
                <table className="w-full text-left text-sm whitespace-nowrap">
                  <thead className="bg-white border-b border-slate-200 text-slate-500 text-xs uppercase tracking-wider">
                    <tr>
                      ...
                      <th className="px-6 py-5 font-bold text-center">Upfront CapEx (Setup)</th>
                  ...
                  <tbody className="divide-y divide-slate-100">
                    ...
                    <tr className="hover:bg-slate-50 transition-colors">
                      ...
                      <td className="px-6 py-5">
                        <span className="text-[11px] font-bold text-red-600 bg-red-50 border border-red-100 px-2.5 py-1 rounded">Break-Fix (Billed Extra)</span>
                      </td>
                    </tr>
                    <tr className="hover:bg-slate-50 transition-colors">
                      <td className="px-6 py-5 font-medium text-slate-800">
            ...
            <p className="text-center text-slate-500 text-sm max-w-4xl mx-auto italic mt-4">
