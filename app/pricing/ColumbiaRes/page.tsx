  ...
  return (
    <>
      ...
      <div className="hidden print:block bg-white text-black min-h-screen p-8 font-sans w-full max-w-[8.5in] mx-auto">
        ...
        <table className="w-full text-left mb-10 border-collapse">
          <thead>
            <tr className="border-b-2 border-zinc-800 text-xs uppercase tracking-widest text-zinc-500">
              ...
              <th className="pb-3 font-bold">Ped. Doors</th>
          ...
          <tbody className="text-sm">
            {sites.map((site, index) => (
              <tr key={index} className="border-b border-zinc-200">
                ...
                <td className="py-4 text-zinc-600">{site.pedGates} <span className="text-[10px] text-red-500 ml-1">{site.pedGatesRepair > 0 ? `(${site.pedGatesRepair} broken)` : ''}</span></td>
        ...
        <div className="mt-12 text-[10px] text-zinc-400 text-center uppercase tracking-widest font-bold">
          Gate Guard • SOC-2 Type II Certified • 99.99% Guaranteed Uptime SLA
        </div>
      </div>
